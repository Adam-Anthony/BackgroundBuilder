...
def EventsTable(luvVal):
    ...
    ## Love and Marriage
        ...
        if luv == False:
            ...
            result = '    You fell in love or got married. You can choose to to have a child instead.'
    ## Adventurer as Foe
    elif roll >= 31 and roll <= 40:
        result = '    You made an enemy of an adventurer,'
    ...
    ## Working a job 
        ...
        result = '    You spent time working in a job related to your background. '
    ...
    ## Onto an adventure
        ...
        result = '    You went on an adventure.\n'
        ## Roll on the Adventure table
        result += Adventures()
    ## Supernatural Experience
    elif roll >= 81 and roll <= 85:
        result = '    You had a supernatural experience.\n'
        ## Roll on the Supernatural table
        result += Supernatural()
    ## Fought in battle
    elif roll >= 86 and roll <= 90:
        result = '    You fought in a battle.\n'
        ## Roll on the War table
        result += War()
    ## Crime Accussal
    elif roll >= 91 and roll <= 95:
        result = '    You commited a crime or were wrongly accused of doing so.\n'
    ...
    ## Encounted something magical
        ...
        result = '    You encountered something magical.\n'
...
def Tragedies():
    ...
    if roll == 1 or roll == 2:
        ...
        result = 'A romantic relationship ended.'
