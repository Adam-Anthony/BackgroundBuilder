...
class FamilyLife():
    ...
    def ChildhoodMemories(self):
        ...
        result = ''
        if roll <= 3:
            result += 'I am still haunted by my childhood, when I was treated badly by my peers.'
        elif roll >= 4 and roll <= 5:
            result += 'I spent most of my childhood alone, with no close friends.'
        elif roll >= 6 and roll <= 8:
            result += 'Others saw me as being different or strange, and so I had few companions.'
        elif roll >= 9 and roll <= 12:
            result += 'I had a few close friends and lived an ordinary childhood.'
        elif roll >= 13 and roll <= 15:
            result += 'I had several friends, and my childhood was generally a happy one.'
        elif roll >= 16 and roll <= 17:
            result += 'I always found it easy to make friends, and I loved being around people.'
        elif roll >= 18:
            result += 'Everyone knew who I was, and I had friends everywhere I went.'
        return result 
